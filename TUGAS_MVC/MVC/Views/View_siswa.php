...
?>
        ...
        <h3 class="card text-center" ><a type="button" class="btn btn-outline-light"  style="background-color: #BA4A00;" href="main.php?menu=<?php echo base64_encode('po_siswa') ?>">Tambahkan Data</a></h3>
